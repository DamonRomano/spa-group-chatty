...
Team members were [Cory Tohill](corytohill.github.io/), [Damon Romano](damonromano.github.io), and [Simon Herrera](simonherrera.github.io). 

Chatty was the first significant group project for the front-end development portion of Nashville Software School's Full-Time Developer Boot Camp. The assignment was to build the interface for an instant messaging app. The requirements, as given by our instructors, are retained below so you may compare our group's final result to the challenge as presented.  

Compared to other groups in NSS Day Cohort 13, our group's only notable departure was our decision to set up the JSON as an array of strings rather than of objects. It saved us a few lines. At the time, we thought ourselves very slick.
